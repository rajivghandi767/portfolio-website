...
def setup_cleanup_signals():
    ...
    for model in apps.get_models():
        ...
        # Connect signals
        pre_save.connect(delete_old_file_on_save, sender=model, dispatch_uid=f"{model.__name__}_cleanup_pre_save")
        post_delete.connect(delete_file_on_delete, sender=model, dispatch_uid=f"{model.__name__}_cleanup_post_delete")
